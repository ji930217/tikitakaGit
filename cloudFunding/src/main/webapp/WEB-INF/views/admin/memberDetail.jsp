...
<div style="left:0px" class="b-valign  b-valign--origin-left">
  <div class="b-valign__inner">
    ...
    <div class="b-valign__ie7_helper">
      ...
      <h2 class="headline is_vaporable" style="opacity: 3.27318;">프로필 상세보기</h2>
  ...
  <div class="b-valign__inner">
    ...
    <div class="b-valign__ie7_helper">
      ...
      <ul class="b-menu b-menu_horiz_yes is_vaporable" style="opacity: 3.67969;">
        <!-- <li class="b-menu__item"> <a href="memberDetail.do" class="b-menu__item__link">프로필 상세보기</a></li> -->
...
<%--  <img alt="Avatar_4.png?ixlib=rb-1.1.0&amp;w=200&amp;h=250&amp;auto=format%2ccompress&amp;fit=facearea&amp;facepad=2" class="b-avatar__pic" src="${mDetail[0].profile_img }?ixlib=rb-1.1.0&amp;w=200&amp;h=250&amp;auto=format%2Ccompress&amp;fit=facearea&amp;facepad=2.0&amp;ch=Save-Data&amp;mask=ellipse&amp;s=47b7f1fde4079f1f411c9d0c1c73fc83">
 --%>
</div>   
</div>
      </div>
  ...
  <div class="b-form-list">
    <label class="b-form__label text-size_xs" for="user_fullname">
      이름
</label>    <input class="b-form__item form-field col-3" id="user_fullname" name="name" type="text" value="${mDetail[0].name }"> </span></div>

  <div class="b-form-list">
    <label class="b-form__label text-size_xs" for="user_locname">
      지역
</label>    <input class="b-form__item form-field col-5" id="user_locname" name="location" type="search" value="${mDetail[0].location }"> </span></div>
  ...
  <div class="b-form-list b-form-list--top">
    <label class="b-form__label text-size_xs" for="user_short_description">
      ...
      <textarea class="form-field" id="user_short_description" name="shortDescription" rows="3">${mDetail[0].shortDescription }</textarea>
    </div>
  ...
  <div class="b-form-list">
    <label class="b-form__label text-size_xs" for="user_homepage">
      ...
      <input class="form-field col5" id="user_homepage" name="homepage" type="url" value = "${mDetail[0].homepage }">
    </div>
  ...
  <div class="b-form-list">
    ...
    <div class="b-form__item">
      <input class="form-field col-2" id="user_phone1" name="phone1" size="30" type="tel" value = "${mDetail[0].phone1 }">
      <input class="form-field col-2" id="user_phone2" name="phone2" size="30" type="tel" value = "${mDetail[0].phone2 }">
      <input class="form-field col-2" id="user_phone3" name="phone3" size="30" type="tel" value = "${mDetail[0].phone3 }">
      </span></div>
 ...
 -->  </div>
  ...
  <div class="b-form-list"> 
    ...
    <div class="b-form__item">
      ...
      <input class="b-button b-button_size_l" name="commit" type="button" onclick = "backAdminList();" value="돌아가기">
    </div>
  </div>
