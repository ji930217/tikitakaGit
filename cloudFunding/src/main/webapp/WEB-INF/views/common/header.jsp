...
<head>
  ...
  <meta name="application-name" content="tumblbug">
      ...
      <style type="text/css" data-styled-components="cXdlcp bYqief fzoeFq jPcWZN iVCTYT jdgWcI bteafZ kZLTLQ hcvfVq iGOIal kizyZz cfMrMC hHUgvf bpfGNO JUlEd buZCDD fQwQfp gqXDKx labhhf eQgQLo dLYLGx hGGMaO btBxPj cgjPcA jYcZV ewshKB iTXcwb fkKFAu yFLvh buxDxm csIfer eTTrro dvkZSH hZQjKf eMTBgh dxWcyc cdAaGX hIzDiB hhJJZS hSyZGE bKYVaX jKslKa bIabCF fGeOXz" data-styled-components-is-local="true">
...
.hSyZGE {display: inline-block;background-image: url(https://tumblbug-upi.imgix.net/f857545de46a388bad0e0366233333b30c4b7d50.jpg?ixlib=rb-1.1.0&w=200&h=200&auto=format%2Ccompress&fit=facearea&facepad=2.0&ch=Save-Data&mask=ellipse&s=ea9a4f216e89e28e9b47788c56c4df06);width: 25px;height: 25px;background-size: cover;background-position: 50% 38%;border-radius: 50%;border: 1px solid #ddd;margin-right: .5rem;}
...
.sc-bwzfXH {}
.hIzDiB {display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;-webkit-align-items: center;-webkit-box-align: center;-ms-flex-align: center;align-items: center;-webkit-box-pack: center;-webkit-justify-content: center;-ms-flex-pack: center;justify-content: center;margin: 0 auto;height: 100vh;}
...
.hhJJZS {margin-left: 0.5em;cursor: pointer;}</style>
    <style type="text/css" data-styled-components="gXCSaI gDcVdH bwyOOq dvzFpS dPAoUk jBPHQu eiVCyY hvPJrg bPHUVK XTtld cwYjsy enzRKc hEIXJa ikLgAw cyOybj iuosEt gXZEJk kBDldE brhEhF iCczEI ilHpOi GTIIn fdKmEL cWTOml hJaXtH cEJRUu cdILTf fnDmjB kCwSCH bsAzyf kUVMFn iYdQWI gQpQVg dtwFgh OZgBR bVfzeY lhFUmi NzsAu gfyIVD knAdBT iZgHCU hDDlHs kEslfd cEpmyj gICyhK fnqoB ebFTii dWuoYc" data-styled-components-is-local="true">
...
.iZgHCU {display: inline-block;height: 2.25em;position: relative;vertical-align: top;}.iZgHCU:after {border: 2px solid black;border-right: 0;border-top: 0;content: "";display: block;height: 0.5em;pointer-events: none;position: absolute;-webkit-transform: rotate(-45deg);-webkit-transform: rotate(-45deg);-ms-transform: rotate(-45deg);transform: rotate(-45deg);width: 0.5em;margin-top: -0.4em;right: 1.125em;top: 50%;z-index: 4;}
/* sc-component-id: PageIntroduction__ProjectsSortDropdown-s7qbeqe-4 */
.PageIntroduction__ProjectsSortDropdown-s7qbeqe-4 {}
.hDDlHs {-moz-appearance: none;-webkit-appearance: none;-webkit-box-align: center;-ms-flex-align: center;-webkit-align-items: center;-webkit-box-align: center;-ms-flex-align: center;align-items: center;border: none;border-radius: 3px;box-shadow: none;display: -webkit-inline-box;display: -webkit-inline-box;display: -webkit-inline-flex;display: -ms-flexbox;display: inline-flex;display: -webkit-inline-box;display: -webkit-inline-flex;display: -ms-flexbox;display: inline-flex;font-size: 1rem;height: 2.25em;-webkit-box-pack: start;-ms-flex-pack: start;-webkit-box-pack: start;-webkit-justify-content: flex-start;-ms-flex-pack: start;justify-content: flex-start;line-height: 1.25;padding: 0.5em 0.625em;position: relative;vertical-align: top;background-color: white;border: none;color: #black;cursor: pointer;display: block;font-size: 1em;font-weight: bold;outline: none;width: 8em;}
...
.fnqoB {display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;-webkit-box-pack: center;-webkit-justify-content: center;-ms-flex-pack: center;justify-content: center;-webkit-flex-wrap: wrap;-ms-flex-wrap: wrap;flex-wrap: wrap;width: 100%;margin: 10px 0 30px;}@media (min-width: 1080px) {.fnqoB {margin: 20px 0 40px;-webkit-box-pack: start;-webkit-justify-content: flex-start;-ms-flex-pack: start;justify-content: flex-start;}}
...
.eAgLGx {max-width: 100%;height: 100%;display: none;}@media (min-width: 1080px) {.eAgLGx {float: right;display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;-webkit-align-items: center;-webkit-box-align: center;-ms-flex-align: center;align-items: center;margin: 0 2rem;}}
...
.bReGoj {font-size: .8rem;font-weight: bold;margin: -.2rem -.1rem 0 .2rem;}</style><style type="text/css" data-styled-components="cNWmvR jPEdlL kJUlye giKgfw bJXRvz iChtTV deZznN cBbkfc fuCNpE eYscdN fVfxlF dHxdxH iBGoJt khYIRi bfEmee spnVx kcmHIB hBOBRE cEqFlc iwEBnW etxsCe dQJbED dOjYPK kDYAge iYIWgz gSgsr chNsfw ceunQL" data-styled-components-is-local="true">
...
.deZznN {width: 100%;}@media (min-width: 1080px) {.deZznN {min-height: 500px;}}</style><style type="text/css" data-styled-components="" data-styled-components-is-local="true"></style><style type="text/css" data-styled-components="ewlCRY hIkOXr fQMvgC umGxa gjgpkL gDEKBn bvwsV gByEjI gOXuOg hPoBAu cgTcFG bAjPoG dtFXbm frQalE cDaykX ldtjlR bHyDWq" data-styled-components-is-local="true">
...
.cDaykX {width: 100%;display: block;}@media (min-width: 1080px) {.cDaykX {display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;-webkit-align-items: center;-webkit-box-align: center;-ms-flex-align: center;align-items: center;-webkit-box-pack: space-between;-webkit-justify-content: space-between;-ms-flex-pack: space-between;justify-content: space-between;}}
