...
.eTTrro {
	display: inline-block;
	background-image:
		url(https://tumblbug-upi.imgix.net/2f6713adb430784844b96165cae5b1ab3c456bdf.jpg?ixlib=rb-1.1.0&w=200&h=200&auto=format%2Ccompress&fit=facearea&facepad=2.0&ch=Save-Data&mask=ellipse&s=74edf7d16a3611e08a0ee0fd73ac3178);
	width: 25px;
	height: 25px;
	background-size: cover;
	background-position: 50% 38%;
...
.hSyZGE {
	display: inline-block;
	background-image:
		url(https://tumblbug-upi.imgix.net/f857545de46a388bad0e0366233333b30c4b7d50.jpg?ixlib=rb-1.1.0&w=200&h=200&auto=format%2Ccompress&fit=facearea&facepad=2.0&ch=Save-Data&mask=ellipse&s=ea9a4f216e89e28e9b47788c56c4df06);
	width: 25px;
	height: 25px;
	background-size: cover;
	background-position: 50% 38%;
...
<style type="text/css"
	data-styled-components="hEFTbE bxRvdW cEnTNJ nuOjL fmLEMz jftTar gEQpFE ykGDF hOKtVI bzwbvF bmtKYw qHzrD cSKjGh iSHaZi jtYVGd ervGwJ hgvQtm iEZvlH hEilqP fNAOQh iToKBr jfnFWI bzlVdT dUSIGe fhXjWk duKZDT hFAREh bGqbmB fOsIlY kCGzYC gEZuLR gUQbvW cWrfUF beYdFz ddAStM bpoHzD lfgWGK iJcLQj"
	data-styled-components-is-local="true">
...
<style type="text/css"
	data-styled-components="hsuyOO isebXd gKkJpB yNdyg boFKej cyqGTD guVzeB gDTPbS iTDPPg dIHovk feRhij gujNFh eIDmsW leXkjY htCDgL bvKOwU ihuRTA kIYDgq kwAiqA bBsoai fjkRCm cYmhAj lblHJx eeeApW eSsILz gEWplf bReGoj jtCReq eAgLGx cHpUtP"
	data-styled-components-is-local="true">
...
<style type="text/css"
	data-styled-components="cNWmvR jPEdlL kJUlye giKgfw bJXRvz iChtTV deZznN cBbkfc fuCNpE eYscdN fVfxlF dHxdxH iBGoJt khYIRi bfEmee spnVx kcmHIB hBOBRE cEqFlc iwEBnW etxsCe dQJbED dOjYPK kDYAge iYIWgz gSgsr chNsfw ceunQL"
	data-styled-components-is-local="true">
...
<style type="text/css"
	data-styled-components="ewlCRY hIkOXr fQMvgC umGxa gjgpkL gDEKBn bvwsV gByEjI gOXuOg hPoBAu cgTcFG bAjPoG dtFXbm frQalE cDaykX ldtjlR bHyDWq"
	data-styled-components-is-local="true">
...
.hIkOXr>i {
	-webkit-animation: fzoeFq 1s infinite;
		...
		$(".cwYjsy")
				.click(
						function() {
							...
							if ($(this).children("span").eq(1).children("div")
									.attr("class") == "DiscoverMenuDropdown__TriangleUpIcon-s116h97f-0 bVfzeY") {
								$(this).children("span").eq(1).children("div")
										.removeClass();
								$(this)
										.children("span")
										.eq(1)
								...
								$(this).children("span").eq(1).children("div")
										.addClass("OZgBR");
							} else if ($(this).children("span").eq(1).children(
									"div").attr("class") == "DiscoverMenuDropdown__TriangleDownIcon-s116h97f-1 OZgBR") {
								$(this).children("span").eq(1).children("div")
										.removeClass();
								$(this)
										.children("span")
			...
			<div class="SiteHeader__SiteHeaderMenu-s1s56ls8-1 bteafZ"
				...
				<div class="SiteHeader__LeftMenu-s1s56ls8-2 kZLTLQ" data-reactid="8">
					...
					<span class="SiteHeader__ForMobile-s1s56ls8-9 kizyZz"
						...
						href="projectStart.do" data-reactid="13"><span
						...
						<div class="FullscreenModal__ModalBody-s1csgj37-5 eiVCyY">
							...
							<div class="Container__Container-s1sxg7g4-0 iTXcwb">
								...
								<div>
									<div>
										<div class="MenuItem__MenuItem-no2u3j-0 cwYjsy">
											...
											<span>
												<div
													class="DiscoverMenuDropdown__TriangleDownIcon-s116h97f-1 OZgBR"></div>
											</span>
										</div>
									</div>
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/game"> <!-- react-text: 849 -->모든 <!-- /react-text -->
												<!-- react-text: 850 -->게임<!-- /react-text --> <!-- react-text: 851 -->
												프로젝트<!-- /react-text -->
											</a>
										</div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/performance"> <!-- react-text: 865 -->모든
												<!-- /react-text --> <!-- react-text: 866 -->공연<!-- /react-text -->
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/design"> <!-- react-text: 929 -->모든 <!-- /react-text -->
												<!-- react-text: 930 -->디자인<!-- /react-text --> <!-- react-text: 931 -->
												프로젝트<!-- /react-text -->
											</a>
										</div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/comics"> <!-- react-text: 987 -->모든 <!-- /react-text -->
												<!-- react-text: 988 -->만화<!-- /react-text --> <!-- react-text: 989 -->
												프로젝트<!-- /react-text -->
											</a>
										</div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/art"> <!-- react-text: 1001 -->모든 <!-- /react-text -->
												<!-- react-text: 1002 -->미술<!-- /react-text --> <!-- react-text: 1003 -->
												프로젝트<!-- /react-text -->
											</a>
										</div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/film-and-video"> <!-- react-text: 2531 -->모든
												<!-- /react-text --> <!-- react-text: 2532 -->영화 ∙ 비디오<!-- /react-text -->
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/food"> <!-- react-text: 2549 -->모든 <!-- /react-text -->
												<!-- react-text: 2550 -->푸드<!-- /react-text --> <!-- react-text: 2551 -->
												프로젝트<!-- /react-text -->
											</a>
										</div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/publication"> <!-- react-text: 2560 -->모든
												<!-- /react-text --> <!-- react-text: 2561 -->출판<!-- /react-text -->
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/technology"> <!-- react-text: 2586 -->모든
												<!-- /react-text --> <!-- react-text: 2587 -->테크놀로지<!-- /react-text -->
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/fashion"> <!-- react-text: 2600 -->모든
												<!-- /react-text --> <!-- react-text: 2601 -->패션<!-- /react-text -->
								...
								<div>
									...
									<div>
										<div class="DropdownItem__DropdownItem-s12jl0ab-0 lhFUmi">
											<a href="/category/campaign"> <!-- react-text: 2614 -->모든
												<!-- /react-text --> <!-- react-text: 2615 -->캠페인<!-- /react-text -->
