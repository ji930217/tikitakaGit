...
.bmtKYw {
	...
	width: 100%;
	height: 100%;
	background-image: url('resources/images/header/tumblbug-assets.imgix.net/assets/ProjectStart/projectstart-banner-background.png');
	background-size: cover;
	background-position: center center;
	opacity: 0.5;
}
...
/* $('#carouselExampleIndicators').carousel({
	...
	$(function(){
		...
		if (sessionStorage.getItem("btnIdx") == 1) {
			$("#prevPopularProjectBtn").prop("disabled", true);
		}
		nextPopularProject();
		console.log(sessionStorage.getItem("btnIdx"));
		...
		$("#prevPopularProjectBtn").click(function() {
			...
			prevPopularProject();
			if(sessionStorage.getItem("btnIdx") > 1){
				$("#nextPopularProjectBtn").prop("disabled", false);
			}
		...
		$("#nextPopularProjectBtn").click(function() {
			...
			if (sessionStorage.getItem("btnIdx") >= 17) {
				$("#nextPopularProjectBtn").prop("disabled", true);
			}
			nextPopularProject();
			if(sessionStorage.getItem("btnIdx") < 17){
				$("#prevPopularProjectBtn").prop("disabled", false);
			}
	...
	//최신 프로젝트
	$(function(){
		sessionStorage.setItem("btnIdx1", 1);
		console.log(sessionStorage.getItem("btnIdx1"));
		if (sessionStorage.getItem("btnIdx1") == 1) {
			$("#prevEnrollDateProjectBtn").prop("disabled", true);
		}
		nextEnrollDateProject();
		console.log(sessionStorage.getItem("btnIdx1"));
		
		
		$("#prevEnrollDateProjectBtn").click(function() {
			
			var btnIdx1 = parseInt(sessionStorage.getItem("btnIdx1"));
			console.log(btnIdx1);
			sessionStorage.setItem("btnIdx1", btnIdx1 - 4);
			console.log(sessionStorage.getItem("btnIdx1"));
			if (sessionStorage.getItem("btnIdx1") <= 1) {
				$("#prevEnrollDateProjectBtn").prop("disabled", true);
			}
			prevEnrollDateProject();
			if(sessionStorage.getItem("btnIdx1") > 1){
				$("#nextEnrollDateProjectBtn").prop("disabled", false);
			}
		...
		$("#nextEnrollDateProjectBtn").click(function() {
			
			var btnIdx1 = parseInt(sessionStorage.getItem("btnIdx1"));
			console.log(btnIdx1);
			sessionStorage.setItem("btnIdx1", btnIdx1 + 4);
			console.log(sessionStorage.getItem("btnIdx1"));
			if (sessionStorage.getItem("btnIdx1") >= 17) {
				$("#nextEnrollDateProjectBtn").prop("disabled", true);
			}
			nextEnrollDateProject();
			if(sessionStorage.getItem("btnIdx1") < 17){
				$("#prevEnrollDateProjectBtn").prop("disabled", false);
			}
	...
	//마감 앞둔 프로젝트
	$(function(){
		sessionStorage.setItem("btnIdx2", 1);
		console.log(sessionStorage.getItem("btnIdx2"));
		if (sessionStorage.getItem("btnIdx2") == 1) {
			$("#prevDeadLineProjectBtn").prop("disabled", true);
		}
		nextDeadLineProject();
		console.log(sessionStorage.getItem("btnIdx2"));
		
		
		$("#prevDeadLineProjectBtn").click(function() {
			
			var btnIdx2 = parseInt(sessionStorage.getItem("btnIdx2"));
			console.log(btnIdx2);
			sessionStorage.setItem("btnIdx2", btnIdx2 - 4);
			console.log(sessionStorage.getItem("btnIdx2"));
			if (sessionStorage.getItem("btnIdx2") <= 1) {
				$("#prevDeadLineProjectBtn").prop("disabled", true);
			}
			prevDeadLineProject();
			if(sessionStorage.getItem("btnIdx2") > 1){
				$("#nextDeadLineProjectBtn").prop("disabled", false);
			}
		...
		$("#nextDeadLineProjectBtn").click(function() {
			
			var btnIdx2 = parseInt(sessionStorage.getItem("btnIdx2"));
			console.log(btnIdx2);
			sessionStorage.setItem("btnIdx2", btnIdx2 + 4);
			console.log(sessionStorage.getItem("btnIdx2"));
			if (sessionStorage.getItem("btnIdx2") >= 17) {
				$("#nextDeadLineProjectBtn").prop("disabled", true);
			}
			nextDeadLineProject();
			if(sessionStorage.getItem("btnIdx2") < 17){
				$("#prevDeadLineProjectBtn").prop("disabled", false);
			}
...
function prevEnrollDateProject() {
		
		var btnIdx1 = parseInt(sessionStorage.getItem("btnIdx1"));
		
		$.ajax({
					url : "index_enrollDateList.do",
					type : "post",
					data : {
						btnIdx1 : btnIdx1
					},
					success : function(data) {
						var $enrollDateProjectListDiv = $("#enrollDateProjectListDiv");
						var resultStr = "";
						for ( var key in data) {
							/* console.log(data[key]); */
							var percent = parseInt(data[key].currentAmount
						...
						$enrollDateProjectListDiv.html(resultStr);
	...
	function nextEnrollDateProject() {
	...
	//마감
function prevDeadLineProject() {
		
		var btnIdx2 = parseInt(sessionStorage.getItem("btnIdx2"));
		
		$.ajax({
					url : "index_DeadlineList.do",
					type : "post",
					data : {
						btnIdx2 : btnIdx2
					},
					success : function(data) {
						var $deadLineProjectListDiv = $("#deadLineProjectListDiv");
						var resultStr = "";
						for ( var key in data) {
							/* console.log(data[key]); */
							var percent = parseInt(data[key].currentAmount
						...
						$deadLineProjectListDiv.html(resultStr);
...
<div class="Container__Container jdgWcI" data-reactid="78">
  ...
  <div data-reactid="185">
   ...
   <div class="Divider__Divider-s16ihjfx-0 hEIXJa" data-reactid="194"></div>    
    ...
    <div id="enrollDateProjectListDiv" class="Carousel__CarouselContents iEZvlH" data-reactid="91">
   ...
   <div data-reactid="79">
    ...
    <div id="deadLineProjectListDiv" class="Carousel__CarouselContents iEZvlH" data-reactid="91">
      
    </div>
  </div>
</div>
<div>
<a href="projectStart.do" >
	<div class="ProjectStartBanner__ProjectStartBannerWrapper-nl10hp-0 hOKtVI" data-reactid="199">
		...
		<h2 class="ProjectStartBanner__Title-nl10hp-3 qHzrD" data-reactid="202">
			...
			<span data-reactid="204">티키타카에서 현실로</span>
		</h2>
