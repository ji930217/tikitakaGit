...
<style type="text/css"
	data-styled-components="cXdlcp bYqief fzoeFq dscTqG inuSWg ZUBNV gSRmTx cUacwB"
...
.cUacwB:hover, .cUacwB:focus, .cUacwB:active {
...
.ZUBNV {
	...
	height: 6rem;
	width: 6rem;
	border: 10px dotted #e7e7e7;
	border-radius: 50%;
	opacity: .3;
	-webkit-animation: fadeIn 2s ease-in-out infinite;
	animation: fadeIn 2s ease-in-out infinite;
	-webkit-transition: fadeIn 3s ease-in-out infinite;
	-moz-transition: fadeIn 3s ease-in-out infinite;
}
...
<body>
	<div data-reactroot="" data-reactid="1"
		data-react-checksum="1618970729">
		<div class="NotFound__NotFoundPage-s17v2whf-0 dscTqG" data-reactid="3">
			<div class="NotFound__ErrorNumber-s17v2whf-1 inuSWg" data-reactid="4">4<div class="NotFound__MissingZero-s17v2whf-3 ZUBNV" data-reactid="6"></div>4
				
			</div>
			<div class="NotFound__ErrorMessage-s17v2whf-2 gSRmTx"
				data-reactid="8">죄송합니다. 페이지를 준비중입니다</div>
			<a><button class="Button__Button-s1ng5xda-0 cUacwB" data-reactid="9"  onclick="location.href='index.do'">티키타카
				홈으로 돌아가기</button>
		</div>
	</div>
	<script type="application/javascript"
		src="https://d2om2e6rfn032x.cloudfront.net/wpa/bundle.app.e7b8de0e233cf13f392b.js">
