...
.cUacwB {cursor: pointer;display: inline-block;min-height: 1em;outline: none;border: none;vertical-align: baseline;box-shadow: 0px 0px 0px 1px transparent inset, 0px 0em 0px 0px rgba(0, 0, 0, 0.1) inset;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;-webkit-transition: opacity 0.1s ease, background-color 0.1s ease, color 0.1s ease, box-shadow 0.1s ease,background 0.1s ease;transition: opacity 0.1s ease, background-color 0.1s ease, color 0.1s ease, box-shadow 0.1s ease,background 0.1s ease;-webkit-tap-highlight-color: transparent;margin: 0 .25em 0 0;border-radius: 0.28571429rem;text-transform: none;text-shadow: none;font-weight: bold;line-height: 1em;font-style: normal;text-align: center;text-decoration: none;}.cUacwB > i {margin: 0 .42857143em 0 -.21428571em;}.cUacwB {color: rgba(0, 0, 0, .6);background-color: #e7e7e7;}.cUacwB:hover,.cUacwB:focus,.cUacwB:active {background-color: #d9d9d9;color: rgba(0, 0, 0, 8);}.cUacwB {padding: 1.2em 2em;font-size: 1.1em;width: ;opacity: 1;pointer-events: ;;}
...
/* sc-component-id: NotFound__NotFoundPage-s17v2whf-0 */

.dscTqG {height: 100vh;width: 100%;display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;-webkit-flex-direction: column;-ms-flex-direction: column;flex-direction: column;-webkit-box-pack: center;-webkit-justify-content: center;-ms-flex-pack: center;justify-content: center;-webkit-align-items: center;-webkit-box-align: center;-ms-flex-align: center;align-items: center;background-color: #fff;font-weight: bolder;color: #e7e7e7;overflow: hidden:}
/* sc-component-id: NotFound__ErrorNumber-s17v2whf-1 */

.inuSWg {font-size: 8rem;font-family: avenir;margin-bottom: 3rem;}@media (min-width: 1080px) {.inuSWg {font-size: 15rem;margin-bottom: 5rem;}}
/* sc-component-id: NotFound__ErrorMessage-s17v2whf-2 */

.gSRmTx {font-size: 2rem;margin-bottom: 4rem;word-break: keep-all;max-width: 90%;text-align: center;line-height: 1.4;}@media (min-width: 1080px) {.gSRmTx {font-size: 3rem;margin-bottom: 6rem;}}
/* sc-component-id: NotFound__MissingZero-s17v2whf-3 */

.ZUBNV {display: inline-block;margin: 0 .5rem;height: 6rem;width: 6rem;border: 10px dotted #e7e7e7;border-radius: 50%;opacity: .3;-webkit-animation:fadeIn 2s ease-in-out infinite;animation:fadeIn 2s ease-in-out infinite;-webkit-transition: fadeIn 3s ease-in-out infinite;-moz-transition: fadeIn 3s  ease-in-out infinite;}@-webkit-keyframes fadeIn {0% {opacity: .3;}50% {opacity: 1;}100% {opacity: .3;}}@keyframes fadeIn {0% {opacity: .3;}50% {opacity: 1;}100% {opacity: .3;}}@media (min-width: 1080px) {.ZUBNV {margin: 0 1rem;height: 11rem;width: 11rem;}}
...
<body>
<div data-reactroot="" data-reactid="1" data-react-checksum="1618970729"><!-- react-empty: 2 -->
   <div class="NotFound__NotFoundPage-s17v2whf-0 dscTqG" data-reactid="3">
     <div class="NotFound__ErrorNumber-s17v2whf-1 inuSWg" data-reactid="4"><!-- react-text: 5 -->4<!-- /react-text -->
       <div class="NotFound__MissingZero-s17v2whf-3 ZUBNV" data-reactid="6"></div>
        <!-- react-text: 7 -->4<!-- /react-text --></div>
     <div class="NotFound__ErrorMessage-s17v2whf-2 gSRmTx" data-reactid="8">페이지를 찾을 수 없습니다</div>
     <button class="Button__Button-s1ng5xda-0 cUacwB" data-reactid="9">티키타카 홈으로 돌아가기</button>
   </div>
 </div>
