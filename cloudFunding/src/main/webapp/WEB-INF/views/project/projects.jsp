...
<div class="b-main b-main--extended b-main--centered" id="" role="main">
    ...
    <div class="row has-pad-bottom">
      ...
      <c:if test="${lists.pConfirm ne 3 }">
      <div class="b-project-card"> 
  <figure class="b-project-card__head">
    <a onclick="check();" class="b-project-card__head__link" href="updateProjectForm.do?projectCode=<c:out value='${lists.projectCode }'></c:out>">
