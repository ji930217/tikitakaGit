...
<link
	href="https://d1pqmsyqo4bi9.cloudfront.net/assets/app-f9bc96afb1b4362edcbbac34fa577164.css"
	media="screen" rel="stylesheet" type="text/css">
<title>반영구적으로 사용 가능한 실리콘 스트로우 밀어주기 :: 텀블벅</title>
...
<script type="text/javascript">
	analytics.identify("da369f31-11a0-433b-8403-bde1c31d7559", {
		email : "shfkscad10@naver.com",
		name : "김가영"
	});
</script>

<meta property="og:site_name" content="tumblbug">
<meta property="og:title" content="반영구적으로 사용 가능한 실리콘 스트로우">
<meta property="og:url" content="http://www.tumblbug.com/straw">
<meta property="og:description"
	content="공룡, 니모, 오리 모양의 실리콘 스트로우를 만나 보세요">
<meta property="og:type" content="tumblbug:project">
<meta property="og:image"
	content="https://tumblbug-pci.imgix.net/46d0a96a11fbfdf56f8d5d6ad4bada3b20a759fe/61d0d194fdfec7f3d3659213a535d34f5de91f33/d6fe0978b8e1d1330d0a528c2b54dcca32110852/799f44b1-0059-461e-852c-f6a57cfae5b9.jpg?ixlib=rb-1.1.0&amp;w=620&amp;h=465&amp;auto=format%2Ccompress&amp;lossless=true&amp;fit=crop&amp;s=ed5606f59414f1a5c766f41250c36bfd">
<meta property="og:image:width" content="620">
<meta property="og:image:height" content="465">

<meta name="twitter:site" content="tumblbug">
<meta name="twitter:title" content="반영구적으로 사용 가능한 실리콘 스트로우">
<meta name="twitter:description"
	content="공룡, 니모, 오리 모양의 실리콘 스트로우를 만나 보세요">
<meta name="twitter:image:src"
	content="https://tumblbug-pci.imgix.net/46d0a96a11fbfdf56f8d5d6ad4bada3b20a759fe/61d0d194fdfec7f3d3659213a535d34f5de91f33/d6fe0978b8e1d1330d0a528c2b54dcca32110852/799f44b1-0059-461e-852c-f6a57cfae5b9.jpg?ixlib=rb-1.1.0&amp;w=620&amp;h=465&amp;auto=format%2Ccompress&amp;lossless=true&amp;fit=crop&amp;s=ed5606f59414f1a5c766f41250c36bfd">
<meta name="twitter:url" content="http://www.tumblbug.com/straw">
<meta name="twitter:card" content="summary_large_image">
<style type="text/css">
.fb_hidden {
	position: absolute;
...
<body>
	...
	<c:if test="${!empty sessionScope.user }">
	<div class="pledge-container" data-reactid=".v2rkpmv400"
		data-react-checksum="-1192623298">
		<header class="b-header b-header_pledge" data-reactid=".v2rkpmv400.0">
		<div class="b-filter b-filter_beta" data-reactid=".v2rkpmv400.0.0"></div>
		<div class="b-header__content" data-reactid=".v2rkpmv400.0.1">
			<div class="b-header__content-item" data-reactid=".v2rkpmv400.0.1.0">
				<h1 class="b-header__headline" data-reactid=".v2rkpmv400.0.1.0.0">
					<span data-reactid=".v2rkpmv400.0.1.0.0.0">반영구적으로 사용 가능한 실리콘
						스트로우</span><span data-reactid=".v2rkpmv400.0.1.0.0.1"> </span><span
						class="for-screenreader" data-reactid=".v2rkpmv400.0.1.0.0.2">프로젝트
						밀어주기</span>
				</h1>
				<ul class="b-list b-list_pledge-history"
					data-reactid=".v2rkpmv400.0.1.0.1">
					<li class="b-list__item" data-reactid=".v2rkpmv400.0.1.0.1.0"><span
						class="b-list__dot" data-reactid=".v2rkpmv400.0.1.0.1.0.0"></span><a
						class="b-list__link" data-reactid=".v2rkpmv400.0.1.0.1.0.1"><small
							data-reactid=".v2rkpmv400.0.1.0.1.0.1.0">선택한 선물</small><br
							data-reactid=".v2rkpmv400.0.1.0.1.0.1.1"> <span
							data-reactid=".v2rkpmv400.0.1.0.1.0.1.2">1,000원 선물 /
								1,000원 후원</span></a></li>
					<li class="b-list__item" data-reactid=".v2rkpmv400.0.1.0.1.1"><span
						class="b-list__dot" data-reactid=".v2rkpmv400.0.1.0.1.1.0"></span><a
						class="b-list__link" data-reactid=".v2rkpmv400.0.1.0.1.1.1"><small
							data-reactid=".v2rkpmv400.0.1.0.1.1.1.0">전화번호</small><br
							data-reactid=".v2rkpmv400.0.1.0.1.1.1.1"> <span
							data-reactid=".v2rkpmv400.0.1.0.1.1.1.2">010-2256-4303</span></a></li>
					<li class="b-list__item" data-reactid=".v2rkpmv400.0.1.0.1.2"><span
						class="b-list__dot" data-reactid=".v2rkpmv400.0.1.0.1.2.0"></span><a
						class="b-list__link" data-reactid=".v2rkpmv400.0.1.0.1.2.1"><small
							data-reactid=".v2rkpmv400.0.1.0.1.2.1.0">지불 정보</small><br
							data-reactid=".v2rkpmv400.0.1.0.1.2.1.1"> <span
							data-reactid=".v2rkpmv400.0.1.0.1.2.1.2">신한은행 7450</span></a></li>
				</ul>
			</div>
		</div>
		</header>
		<section class="b-section b-section_congrats"
			data-reactid=".v2rkpmv400.1">
		<div class="b-section__content" data-reactid=".v2rkpmv400.1.0">
			<div class="b-panel b-panel_clean b-panel_congrats"
				data-reactid=".v2rkpmv400.1.0.0">
				<div class="b-panel__head" data-reactid=".v2rkpmv400.1.0.0.0">축하합니다</div>
				<section class="b-panel__body" data-reactid=".v2rkpmv400.1.0.0.1">
				<div style="text-align: center;"
					data-reactid=".v2rkpmv400.1.0.0.1.0">
					<span data-reactid=".v2rkpmv400.1.0.0.1.0.0">291</span><span
						data-reactid=".v2rkpmv400.1.0.0.1.0.1">번째 공식 후원자가 되셨습니다</span>
				</div>
				</section>
				<section class="b-panel__body" data-reactid=".v2rkpmv400.1.0.0.2">
				<h1 class="for-screenreader" data-reactid=".v2rkpmv400.1.0.0.2.0">결제
					시기에 관한 안내</h1>
				<small data-reactid=".v2rkpmv400.1.0.0.2.1"><span
					data-reactid=".v2rkpmv400.1.0.0.2.1.0">프로젝트가 목표금액을 모두 달성할
						경우에만 </span><strong data-reactid=".v2rkpmv400.1.0.0.2.1.1">2018년
						9월 3일</strong><span data-reactid=".v2rkpmv400.1.0.0.2.1.2">에 자동
						결제됩니다. 목표액에 미달할 경우 예정된 모든 결제는 자동으로 취소됩니다.</span></small></section>
				<section class="b-panel__body b-menu_pledge"
					data-reactid=".v2rkpmv400.1.0.0.3">
				<h1 class="for-screenreader" data-reactid=".v2rkpmv400.1.0.0.3.0">친구에게
					알리기</h1>
				<a class="b-menu__item b-menu__item_facebook"
					data-reactid=".v2rkpmv400.1.0.0.3.1">페이스북에 알리기</a> <a
					class="b-menu__item b-menu__item_twitter"
					data-reactid=".v2rkpmv400.1.0.0.3.2">트위터에 알리기</a> <a
					class="b-menu__item b-menu__item_pledges"
					href="https://tumblbug.com/pledges"
					data-reactid=".v2rkpmv400.1.0.0.3.3">내 후원현황 보기</a> <a
					class="b-menu__item b-menu__item_home" href="index.do"
					data-reactid=".v2rkpmv400.1.0.0.3.4">메인으로 가기</a></section>
