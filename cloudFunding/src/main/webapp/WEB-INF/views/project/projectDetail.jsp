...
.cabNvZ {display: inline-block;background-image: url(https://tumblbug-upi.imgix.net/eef9fca986d99331c06dde8fb9101cd69371d63e.jpeg?ixlib=rb-1.1.0&w=100&h=125&auto=format%2Ccompress&fit=facearea&facepad=2.0&ch=Save-Data&mask=ellipse&s=2cb3cc67b1f86c91fc8bc285e70c6995);width: 40px;height: 40px;background-size: cover;background-position: 50% 38%;border-radius: 50%;border: 1px solid #ddd;margin-right: 0;}/* sc-component-id: TumblbugLogo__TumblbugLogo-s9od1ls-0 */
					...
					<div class="ProjectPage__ProjectContents-b1letw-1 jPEdlL"
						...
						<div
							...
							<div class="ProjectPage__SubColumnInner-b1letw-5 deZznN"
								data-reactid="115">
								<div class="Card__Card-s1i1esb8-0 bJXRvz" data-reactid="116">
									<div class="CreatorCard__CreatorCardInner-yeytpy-0 cBbkfc"
										data-reactid="117">
										<div class="CreatorCard__CreatorCardLabel-yeytpy-1 fuCNpE"
											data-reactid="118">창작자 소개</div>
										<div class="CreatorCard__CreatorProfile-yeytpy-2 eYscdN"
											data-reactid="119">
											<span class="ProfileImg__ProfileImg-s1o99mme-0 eEUjOO"
												data-reactid="120"></span><a
												href="/u/donobawaromodaza/projects" data-reactid="121"><span
												class="CreatorCard__CreatorName-yeytpy-3 fVfxlF"
												data-reactid="122">millicube 밀리큐브</span></a>
										</div>
										<div class="CreatorCard__CreatorBiography-yeytpy-4 dHxdxH"
											data-reactid="123">2012년부터 6년동안 반려동물만을 생각하며 디자인해온
											반려동물 브랜드 밀리큐브입니다. 밀리큐브는 어느 공간에도 어우러지는 심플하고 따뜻한 감성의 디자인을
											지향하고있으며, 언제나 반려동물들의 따뜻하고 편안한 잠자리를 생각합니다.</div>
										<div class="Divider__Divider-s16ihjfx-0 ilHpOi"
											data-reactid="124"></div>
										<div class="CreatorCard__CreatorStats-yeytpy-5 iBGoJt"
											data-reactid="125">
											진행한 프로젝트
											<b data-reactid="130">2</b>
											밀어준 프로젝트
											<b data-reactid="132">2</b>
										</div>
										<div
									...
									<div style="height:10px; background-color:#f6f5f5;">
									
									</div>
									<%-- 보상 출력할 때 이거 for문 돌려야 해 --%>
									<div class="CreatorCard__CreatorCardInner-yeytpy-0 cBbkfc"
										data-reactid="117">
										<div class="CreatorCard__CreatorCardLabel-yeytpy-1 fuCNpE"
											data-reactid="118">n 명이 선택</div>
										<div class="CreatorCard__CreatorProfile-yeytpy-2 eYscdN"
											data-reactid="119">
											<span class="ProfileImg__ProfileImg-s1o99mme-0 eEUjOO"
												data-reactid="120"></span><a
										...
										<div class="CreatorCard__CreatorBiography-yeytpy-4 NdHxdxH"
											data-reactid="123">이걸 한 줄 만 쓰면?</div>
										<div class="Divider__Divider-s16ihjfx-0 ilHpOi"
											data-reactid="124"></div>
										<div class="CreatorCard__CreatorStats-yeytpy-5 iBGoJt"
											data-reactid="125">
