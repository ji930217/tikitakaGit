...
<head>
  ...
  <meta name="application-name" content="tumblbug">
      ...
      <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script type="text/javascript" async="" src="https://cdn.astronomer.io/analytics.js/v1/jMrtLL6v6xXmMGP7h/analytics.min.js"></script><script type="application/javascript">
        window.MOBX_STATE = {"app":{"ssrLocation":"/catchball2"},"currentUser":{"isLoading":false,"isLoaded":true,"id":750880,"uuid":"3595a029-240c-4ed3-ba5e-ca84dab39b41","fullname":"새로","userPermalink":"domoyozudupinedo","avatarUrl":"https://tumblbug-upi.imgix.net/defaults/avatar_0.png?ixlib=rb-1.1.0&w=200&h=250&auto=format%2Ccompress&fit=facearea&facepad=2.0&ch=Save-Data&mask=ellipse&s=87ba671c98b3debfae8ac85d36d0e7b4","email":"jungin2ya@naver.com","isCreator":true,"isAdmin":false},"pledgeStore":{"apiEndpoint":"/api/v1/pledges.json?fields=id,createdAt,amount,isSurveyRequested,isSurveyResponded,paymentStatus&project=title,coverImageUrl,creatorName,fundingStatus&reward=description,items&&coverImageUrl[h]=240&coverImageUrl[w]=320&coverImageUrl[fit]=crop","isLoading":false,"isLoaded":false,"pledges":[],"pledgesCount":{},"currentPage":1,"filterType":"all","isPledgeDataLoading":false,"isMetaDataLoaded":false,"isPledgeDetailsDataLoading":true},"surveyStore":{"apiEndpoint":"/api/v1/pledges.json?fields=id,createdAt,amount,isSurveyRequested,isSurveyResponded,paymentStatus&project=title,coverImageUrl,creatorName,fundingStatus&reward=description,items&filter=surveyResponseNeeded&coverImageUrl[h]=240&coverImageUrl[w]=320&coverImageUrl[fit]=crop"},"taxpayerInformationStore":{"isLoaded":false},"collectionStore":{"collections":{},"featuredCollections":null},"projectStore":{"projects":{"79dcf7ab-a8be-45c5-9a8c-94834aaa22c2":{"state":"ongoing_reached","id":"79dcf7ab-a8be-45c5-9a8c-94834aaa22c2","title":"1950년대 항구의 라이프 스타일을 담은 캔버스화, 캐치볼","coverImageUrl":"https://tumblbug-pci.imgix.net/4b161a793b1b7d9646d00b52f112de112a6e75e0/79cb1e9a63a04ee35ca3fdf6661c3a110e6399ee/97d10f990f4bb2429938854661b0d83a6c815f12/2f2feac3-b4ae-4002-8820-d67cda1f7cc6.jpg?ixlib=rb-1.1.0&w=620&h=465&auto=format%2Ccompress&lossless=true&fit=crop&s=6e794f5dbf46495ae855eae7f20aceed","creatorName":"브러셔","category":"fashion","fundedAmount":23287800,"fundingGoal":10000000,"fundingDeadline":"2018-08-15T23:59:59+09:00","permalink":"catchball2","summary":"1950년대 미국 동부 항구의 라이프스타일을 담은 CATCH BALL 두번째 협업","fundingStatus":"ongoing_reached","introductionVideoPrefix":null,"isRewardDelivered":false,"pledgesCount":226,"currentUserType":"User","refundExchangePolicy":"1) 단순 변심에 의한 환불은 가능합니다. 가능 시 수수료 제외 환불 가능합니다. \n2) 예상 전달일로부터 15일 이상 전달 지연 시 수수료 포함 후 환불 가능 합니다. \n3) 파손, 불량품 수령시 7일 이내로 교환이 가능합니다. 교환 시 발생하는 배송비는 진행자 부담입니다. \n4) 후원자의 배송지 기재 오류, 후원자가 진행자에게 사전 고지 없이 배송지를 수정해 배송사고가 발생할 경 우 진행자는 최대 1번까지 재발송 해드립니다. 배송비 부담은 후원자에게 있습니다.","postsCount":8,"payoutVersion":3,"paidOutDates":null,"paymentDeadline":"2018-08-22T23:59:59+09:00","expectedPayoutDates":["2018-08-31T23:59:59+09:00"],"shortTitle":"브러셔 캐치볼","location":null,"introductionVideoTranscodingState":"none","coverImageFilename":"2f2feac3-b4ae-4002-8820-d67cda1f7cc6.jpg","creatorBiography":"안녕하세요. 브러셔는 2014년도에 창업한 신발제조 브랜드로 브리티쉬컨츄리(British Country)스타일의 다양한 신발 및 악세서리를 생산, 판매하는 기업입니다.","url":"http://www.tumblbug.com/catchball2","store":"[Circular ~.projectStore]"}},"creators":{"catchball2":{"profileImageUrl":"https://tumblbug-upi.imgix.net/9ab57feb-6f69-49b6-8573-a29d50a15d7b.png?ixlib=rb-1.1.0&w=200&h=200&auto=format%2Ccompress&fit=facearea&facepad=2.0&ch=Save-Data&mask=ellipse&s=b80ed0ae6bc600e7f22c606bc84b5807","hasUploadedProfileImage":true,"name":"브러셔","location":"서울 및 대구","biography":"안녕하세요. 브러셔는 2014년도에 창업한 신발제조 브랜드로 브리티쉬컨츄리(British Country)스타일의 다양한 신발 및 악세서리를 생산, 판매하는 기업입니다.","email":"ceo@brusher.co.kr","isPhoneVerified":true,"isEmailVerified":true,"phoneNumber1":"010","phoneNumber2":"8488","phoneNumber3":"9781","lastLoggedInAt":"2018-08-08T19:53:06+09:00","publishedProjectsCount":2,"pledgedProjectsCount":1,"permalink":"donawajorejimogo"}},"payoutInvoice":{}},"messageThreadStore":{"_unreadThreads":{"asCreator":[],"asUser":[]},"projectFilters":[],"_messageThreads":{},"isLoadingMessageThreads":false,"selectedThreadId":null,"selectedThread":null},"messageArchiveThreadStore":{"_messageArchiveThreads":{},"_paging":{"offset":0,"limit":10,"next":""}},"rewardStore":{},"itemStore":{},"heroStore":{"isLoaded":false},"postStore":{"_cachedProjectId":null,"_posts":{},"_postsPagination":null,"_comments":{},"_cachedPostId":null,"_commentPagination":null},"depositAccountStore":{}};
      </script>
      <style type="text/css" data-styled-components="cXdlcp bYqief fzoeFq jPcWZN iVCTYT jdgWcI bteafZ kZLTLQ hcvfVq iGOIal kizyZz cfMrMC hHUgvf bpfGNO JUlEd buZCDD fQwQfp gqXDKx labhhf hsuyOO isebXd gKkJpB yNdyg boFKej cyqGTD guVzeB gDswhX gDTPbS iTDPPg dIHovk feRhij gujNFh eIDmsW leXkjY htCDgL bvKOwU ihuRTA kIYDgq lfgWGK iJcLQj kwAiqA bBsoai fjkRCm dvkZSH cYmhAj hZQjKf lblHJx eeeApW eSsILz gEWplf bReGoj cNWmvR jPEdlL kJUlye giKgfw bJXRvz ewlCRY eQgQLo dLYLGx hGGMaO btBxPj cgjPcA iChtTV deZznN cBbkfc fuCNpE eYscdN jvEsVv fVfxlF dHxdxH ilHpOi iBGoJt khYIRi dxWcyc hBOBRE jKslKa bIabCF" data-styled-components-is-local="true">
...
.gDswhX {display: inline-block;background-image: url(https://tumblbug-upi.imgix.net/9ab57feb-6f69-49b6-8573-a29d50a15d7b.png?ixlib=rb-1.1.0&w=200&h=200&auto=format%2Ccompress&fit=facearea&facepad=2.0&ch=Save-Data&mask=ellipse&s=b80ed0ae6bc600e7f22c606bc84b5807);width: 25px;height: 25px;background-size: cover;background-position: 50% 38%;border-radius: 50%;border: 1px solid #ddd;margin-right: .5rem;}

.jvEsVv {display: inline-block;background-image: url(https://tumblbug-upi.imgix.net/9ab57feb-6f69-49b6-8573-a29d50a15d7b.png?ixlib=rb-1.1.0&w=200&h=200&auto=format%2Ccompress&fit=facearea&facepad=2.0&ch=Save-Data&mask=ellipse&s=b80ed0ae6bc600e7f22c606bc84b5807);width: 40px;height: 40px;background-size: cover;background-position: 50% 38%;border-radius: 50%;border: 1px solid #ddd;margin-right: 1rem;}
...
@-webkit-keyframes fzoeFq {0%, 100% {-webkit-transform: translateX(0);-ms-transform: translateX(0);transform: translateX(0);}50% {-webkit-transform: translateX(4px);-ms-transform: translateX(4px);transform: translateX(4px);}}@keyframes fzoeFq {0%, 100% {-webkit-transform: translateX(0);-ms-transform: translateX(0);transform: translateX(0);}50% {-webkit-transform: translateX(4px);-ms-transform: translateX(4px);transform: translateX(4px);}}
    ...
    <style type="text/css" data-styled-components="" data-styled-components-is-local="true"></style><style type="text/css" data-styled-components="" data-styled-components-is-local="true"></style><style type="text/css" data-styled-components="bfEmee kcmHIB cEqFlc iwEBnW etxsCe dQJbED dOjYPK kDYAge iYIWgz gSgsr chNsfw jtCReq eAgLGx cHpUtP" data-styled-components-is-local="true">
...
.bfEmee {width: 100%;margin-top: 1rem;}@media (min-width: 1080px) {.bfEmee {margin-top: 2rem;}}</style><style type="text/css" data-styled-components="spnVx" data-styled-components-is-local="true">
/* sc-component-id: Rewards__RewardsLabel-s13hisnh-1 */
.Rewards__RewardsLabel-s13hisnh-1 {}
.spnVx {color: rgba(0,0,0,.7);font-size: 1rem;margin-left: .5rem;margin-bottom: .5rem;line-height: 1.5;}</style><style type="text/css" data-styled-components="" data-styled-components-is-local="true"></style><style type="text/css" data-styled-components="" data-styled-components-is-local="true"></style><style type="text/css" data-styled-components="" data-styled-components-is-local="true"></style><style type="text/css" data-styled-components="" data-styled-components-is-local="true">

	select._13KHfN73YmQgsYHxXvuh_J._3vQWHh2J_erdzly2Ip3e87 {
	    height: 38px;
	    padding: .5em;
	...
	._13KHfN73YmQgsYHxXvuh_J._3D9sfZXrWd8it3eUCuCTc8 {
	...
	._13KHfN73YmQgsYHxXvuh_J._3vQWHh2J_erdzly2Ip3e87 {
	    cursor: pointer;
	    position: relative;
	    display: inline-block;
	    outline: none;
...
<script>
	$(function(){
		...
		$("#messageContent").on('input selectionchange propertychange', function() {
...
<body>
	<div
		class="_13KHfN73YmQgsYHxXvuh_J _3VD8dk3LLVJPKM8Cp39BML _3Syz9fGXYtzMNqK_55A2BW kcTaYKjkwElTUKPqMoNNA _2U1L4ZoSBY1BpyBQHLo1fa">
		<div
			class="_13KHfN73YmQgsYHxXvuh_J _3Syz9fGXYtzMNqK_55A2BW _2-N-uV2y5apkjtxqdVnsop _3m0IZoqVX8N-Jfa0U4h3Tf"
			style="margin-top: -250px; max-height: 500px;">
			<div class="-UobvSeyUG6cEWYnht50S"
				style="background-color: rgb(250, 100, 98); color: white; text-align: center;">창작자에게
				문의하기</div>
			<div class="_3ZgG-OSv0XE3y-h3oPaDsl">
				<div class="_13KHfN73YmQgsYHxXvuh_J _3U6RUH-EASpZ_j8ls1HJyP">
					<div class="_13KHfN73YmQgsYHxXvuh_J _3_IGkn3uaje0g2ZA6Tx9wd">
						<span><label style="color: grey; font-weight: 700;">받는
								사람</label>
						<!-- react-text: 319 --> <!-- /react-text -->
							<label
							class="_13KHfN73YmQgsYHxXvuh_J _1Qdv504-1XMeYXZyb0xQZT _1oJMWnMCW_Y6GmNc1mhqaW _3D9sfZXrWd8it3eUCuCTc8">
								<!-- react-text: 321 -->브러셔<!-- /react-text -->
								<!-- react-text: 322 -->님<!-- /react-text -->
						</label></span>
						<div class="_13KHfN73YmQgsYHxXvuh_J _4S0ikJ5kL9iaC8TQbNr2J"></div>
						<span><label style="color: grey; font-weight: 700;">문의
								내용</label>
						<!-- react-text: 326 --> <!-- /react-text -->
			...
			<div class="X7YR5TpNnzSm-0Uq0m3WG">
				<button onclick="resetMessage();"
					class="_13KHfN73YmQgsYHxXvuh_J _3SbGdzxKM6M_AeOQWLNqks _18T1PLssfUK23Oz9uVd0fv">
					<i class="XNpDqzHUiqPI__G5PUZRk _1QY7TzdLHKX3-BKPDNNYKF"></i>
					<!-- react-text: 311 -->
					취소하기
					<!-- /react-text -->
				</button>
				<button id="sendMessageBtn"
					class="_13KHfN73YmQgsYHxXvuh_J _3SbGdzxKM6M_AeOQWLNqks _18T1PLssfUK23Oz9uVd0fv _2rCeEoFeBzvCYn76udqnww"
					disabled="">
